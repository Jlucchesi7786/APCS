...
public class Compiler {
	...
	private Wall[] defaultWalls = {new Wall("vertical", 30, 6, 1), new Wall("horizontal", 5, 1, 4), new Wall("horizontal", 25, 6, 14), new Wall("vertical", 30, 25, 1), new Wall("horizontal", 6, 25, 18)};
	private Wall[] walls;
